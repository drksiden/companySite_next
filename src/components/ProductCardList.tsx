    ...
    >
      <AnimatePresence>
        {products.map((product) => {
          ...
          const inStock = typeof product.stock_quantity === 'number' 
            ...
            >
              <Card className="h-full flex flex-col overflow-hidden rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300">
                ...
                <CardContent className="p-6 flex-grow flex flex-col">
                  <h3 className="text-lg font-semibold text-foreground mb-1 line-clamp-2 hover:text-primary transition-colors"> {/* Adjusted mb */}
